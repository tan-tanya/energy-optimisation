...
HH_PER_DAY           = 48         # number of half-hour slots in a day
...
MIP_GAP_REL          = 0.05     # accept solutions within 5% of optimal
LP_METHOD            = None     # HiGHS LP-relaxation method override, or None for the HiGHS default
PARALLEL_JOBS        = None     # rank_all_combinations worker processes; None → half of physical cores, 1 → serial
SOLVER_THREADS       = None     # threads per worker solver; None → auto-pair with PARALLEL_JOBS so (workers × threads) ≈ logical cores
